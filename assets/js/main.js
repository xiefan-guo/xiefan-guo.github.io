...
function showPubs(id) {
  if (id == 0) {
    ...
    document.getElementById('select0').style = 'color:#f09228; text-decoration:underline; font-weight:bold;';
    ...
    document.getElementById('select1').style = 'color:#f09228; text-decoration:underline; font-weight:bold;';
    ...
    document.getElementById('select2').style = 'color:#f09228; text-decoration:underline; font-weight:bold;';
    document.getElementById('select0').style = '';
    document.getElementById('select1').style = '';
  } 
}
